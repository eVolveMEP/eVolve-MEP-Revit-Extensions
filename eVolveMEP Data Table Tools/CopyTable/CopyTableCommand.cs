...
internal class CopyTableCommand : IExternalCommand
{
    ...
    internal static System.IO.Stream IconResource => System.Reflection.Assembly.GetExecutingAssembly().GetEmbeddedResource("CopyDataTable_32x32.png");
    ...
    public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
    {
        ...
        {
            ShowErrorMessage(null, ex.Message, Resources.CopyDataTableButtonText.ReplaceLineBreaks(" "));
        }
